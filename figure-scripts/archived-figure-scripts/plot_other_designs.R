...
ggsave(filename = "~/Documents/ALI_EHR/figures/smle_other_tpr_fpr_boxplot.png",
...
avg_des |> 
  ...
  ylab("Stratum")
ggsave(filename = "~/Documents/ALI_EHR/figures/smle_other_designs_heatmap.png",
       device = "png", width = 12, height = 7, units = "in")
...
srs_eff = sim_res |> 
  ...
  dplyr::select(-design)
srs_eff |> 
  write.csv("~/Documents/ALI_EHR/sim-data/srs_eff.csv", 
            row.names = FALSE)
sim_res |>
  ...
  theme(legend.position = "top",
        axis.title = element_text(face = "bold"),
        legend.title = element_text(face = "bold"))
ggsave(filename = "~/Documents/ALI_EHR/figures/smle_other_tpr_fpr_line.png",
       device = "png", width = 12, height = 7, units = "in")
